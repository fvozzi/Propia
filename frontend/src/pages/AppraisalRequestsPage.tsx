...
export function AppraisalRequestsPage() {
  ...
  async function handleShareWhatsApp(appraisalRequest: AppraisalRequest) {
    ...
    try {
      ...
      openWhatsAppShareUrl(buildWhatsAppShareUrl(appraisalRequest.contact, message));
          ...
          return (
            <article key={appraisalRequest.id} className="list-item list-item-actions">
              ...
              <div className="candidate-actions">
                ...
                <a href={`/prelisting/${appraisalRequest.publicToken}`} target="_blank" rel="noreferrer" className="ghost-button button-link">
